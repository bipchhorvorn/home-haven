...
class SessionForm extends React.Component {
    ...
    const pwCallback = () => {
      setTimeout(() => {
        if (pw.length > 0) {
          ...
          setTimeout(() => {
            this.props.processDemoForm(this.state).then(this.props.closeModal);
          }, 500);
        }
      }, 75);
    };
  ...
  render() {
      ...
      errors = (
        <div className="modal__errors-container">
          {this.props.errors.map((error, idx) => {
            return (
              <p key={idx} className="modal__errors-single">
                {error}
              </p>
            );
          })}
    ...
    if (this.props.formType === "Log in") {
      ...
      existingAccountMessage = "Already have an HomeHaven account?";
    }
    ...
    return (
      <div className="modal__form-container">
        ...
        <a
          ...
          className="modal__btn--submit modal__btn--submit-demo modal__btn"
        >
        ...
        {errors}
        <br />
        <form onSubmit={this.handleSubmit} className="ui form modal__form">
          <input
            type="text"
        ...
        <div className="modal__other-form-container">
          <p className="modal__account-msg">{existingAccountMessage}</p>
